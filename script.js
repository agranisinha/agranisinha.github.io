...
function getLOR() {
  return `
    <div class="projects-container">
      ...
      <div class="project-grid">
        <div class="project-card clickable" onclick="openLOR('docs/aliviacare.jpeg')"><h3>Clinical Informatics Internship</h3><p>Alivia Care</p><span class="view-btn">📄 View LOR</span></div>
    ...
    <div class="about-container">
      ...
      <div class="about-card">
        ...
        <div class="home-buttons">
          <button onclick="window.open('docs/Agrani Sinha Resume copy 2.pdf', '_blank')">📄 Open Resume</button>
        </div>
      </div>
    </div>
  `;
